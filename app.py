# # 🛡️ Fix for corrupted macOS hidden style files crashing matplotlib
...
#             # else:
#             #    st.info("ℹ️ The analysis code ran, but no plots were generated or detected.")
...
#                 st.warning("⚠️ File was not UTF-8 encoded. Read using Latin-1. Check data for potential character issues.")
...
#     st.subheader("📝 What would you like to explore or analyze?")
...
#     if st.button("🚀 Generate Analysis Plan", key="start_analysis_button"):
...
#         else:
#             st.warning("⚠️ Please enter a description of what you want to analyze.")

#     # --- Display Generated Plan and Execute Steps ---
#     if st.session_state.analysis_requested:

#         # --- Display and Apply Preprocessing ---
#         st.subheader("🧹 Step 1: Data Preprocessing Code")
...
#                 st.subheader("📊 Step 2: Data Analysis Code")
...
#                 # with st.expander("🔍 Glimpse at Cleaned Data & Info", expanded=False): # Start collapsed
...
#                         st.info("⚠️ These are preliminary insights. Run the analysis to see actual results and get more accurate insights.")
#                         st.markdown(st.session_state.analysis_summary)
#                         st.divider()
...
#             st.info("ℹ️ Apply the preprocessing step first to enable analysis.")
...
# st.sidebar.warning("⚠️ **Caution:** The generated code is executed on the server. While efforts are made to ensure safety, review the code before running, especially with sensitive data or in untrusted environments.")
